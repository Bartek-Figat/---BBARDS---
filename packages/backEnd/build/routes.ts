...
// WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
import { CategoriesController } from './../src/ads/adsController';
// WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
...
const models: TsoaRoute.Models = {
    "Categories": {
        ...
        "properties": {
            ...
            "productCategory": {"dataType":"string","required":true},
            "price": {"dataType":"nestedObjectLiteral","nestedProperties":{"minPrice":{"dataType":"double","required":true},"maxPrice":{"dataType":"double","required":true}},"required":true},
            "date": {"dataType":"nestedObjectLiteral","nestedProperties":{"endDate":{"dataType":"datetime","required":true},"startDate":{"dataType":"datetime","required":true}},"required":true},
            "priceCondition": {"dataType":"string","required":true},
            "adCategory": {"dataType":"string","required":true},
            "productCondition": {"dataType":"string","required":true},
...
export function RegisterRoutes(app: Router) {
    ...
    // ###########################################################################################################
        ...
        app.get('/api/v1/categories',
            ...
            function CategoriesController_getAllCategories(request: any, response: any, next: any) {
            const args = {
            };
        ...
        app.get('/api/v1/categories/:id',
            ...
            function CategoriesController_getAd(request: any, response: any, next: any) {
            const args = {
            ...
            try {
              ...
              const promise = controller.getAd.apply(controller, validatedArgs as any);
              promiseHandler(controller, promise, response, undefined, next);
            } catch (err) {
                return next(err);
            }
        ...
        app.put('/api/v1/:id',
            ...
            function CategoriesController_updateCategory(request: any, response: any, next: any) {
            const args = {
        ...
        app.post('/api/v1/login',
            ...(fetchMiddlewares<RequestHandler>(AuthController)),
            ...(fetchMiddlewares<RequestHandler>(AuthController.prototype.userLogin)),

            function AuthController_userLogin(request: any, response: any, next: any) {
            const args = {
        ...
        // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
        app.get('/api/v1/activate/:token',
            ...(fetchMiddlewares<RequestHandler>(AuthController)),
            ...(fetchMiddlewares<RequestHandler>(AuthController.prototype.emailConfiramtion)),

            function AuthController_emailConfiramtion(request: any, response: any, next: any) {
            const args = {
            ...
            try {
              ...
              const promise = controller.emailConfiramtion.apply(controller, validatedArgs as any);
              promiseHandler(controller, promise, response, undefined, next);
            } catch (err) {
                return next(err);
            }
        ...
        app.post('/api/v1/profile',
            ...
            function ProfileController_userRegister(request: any, response: any, next: any) {
            const args = {
                    request: {"in":"request","name":"request","required":true,"dataType":"object"},
            };
        ...
        // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
        app.post('/api/v1/subscription/retrieve-checkout-session',
            authenticateMiddleware([{"jwt":[]}]),
            ...(fetchMiddlewares<RequestHandler>(SubscriptionController)),
            ...(fetchMiddlewares<RequestHandler>(SubscriptionController.prototype.retrieveSubscriptionSession)),

            function SubscriptionController_retrieveSubscriptionSession(request: any, response: any, next: any) {
            const args = {
                    requestBody: {"in":"body","name":"requestBody","required":true,"dataType":"any"},
            ...
            try {
              ...
              const promise = controller.retrieveSubscriptionSession.apply(controller, validatedArgs as any);
              promiseHandler(controller, promise, response, undefined, next);
            } catch (err) {
                return next(err);
            }

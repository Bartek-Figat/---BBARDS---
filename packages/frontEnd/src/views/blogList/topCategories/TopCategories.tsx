...
export const TopCategories = ({ key, title, value }: CategoriesPropCard) => {
  return (
    <div className="flex justify-between items-center border-b group">
      <div className="text-gray-dark text-lg font-medium group-hover:text-dark-blue group-hover:underline group-hover:underline-offset-1 transition duration-300">
        {title}
      </div>
